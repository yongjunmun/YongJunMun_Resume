...
1. Commit the site files to the repository's default branch.
2. Open the repository's **Settings → Pages**.
3. Under **Build and deployment**, choose **Deploy from a branch**.
4. Select the default branch and the `/ (root)` folder.
5. Save and wait for GitHub Pages to publish the update.
...
- [LinkedIn](https://www.linkedin.com/in/yong-jun-mun/)
- [Email](mailto:junmun234@gmail.com)
